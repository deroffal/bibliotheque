...
L'application est prête à être lancée. On peut créer un premier point d'entrée pour vérifier que l'application est bien lancée à l'aide de la classe [PingController.java](../../src/main/java/fr/deroffal/portail/controller/PingController.java).
...
## Configuration
La configuration de Swagger est simple : il faut ajouter au pom.xml les deux dépendances relatives à `io.springfox` et créer la classe [SwaggerConfiguration.java](../../src/main/java/fr/deroffal/portail/SwaggerConfiguration.java).
